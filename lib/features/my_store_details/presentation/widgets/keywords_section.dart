import 'package:cityswitch_app/features/add_store/presentation/widgets/build_section_title.dart';
...
import 'build_keyword_chip.dart';
...
class _KeywordsSectionState extends State<KeywordsSection> {
  ...
  void _addKeyword() {
    ...
    if (keyword.isNotEmpty) {
      if (context.read<KeywordsCubit>().state.length < 3) {
        context.read<KeywordsCubit>().addKeyword(keyword);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<EditMyStoreCubit, EditMyStoreState>(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // عرض الكلمات المضافة
                  BlocBuilder<KeywordsCubit, List<String>>(
